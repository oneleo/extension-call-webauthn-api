...
export const createWebauthn = async (params: any): Promise<any> => {
...
export const requestWebauthn = async (params: any): Promise<any> => {
...
const parseSignature = (signature: string): [bigint, bigint] => {
  ...
  if (p256SigS > p256.CURVE.n / BigInt(2)) {
    p256SigS = p256.CURVE.n - p256SigS
  }
